    ...
    */
    ...
    $argsFormation = array(
        ...
        'show_in_nav_menus' => true,
            ...
            //Taxonomy
            $taxoFormations = array(
                "label"          => "Formations",
                "labels"         => array(
                     "name"           => "Formations",
                     "all_items"      => "Toutes les Formations",
                     "edit_item"      => "Éditer une Formations",
                     "view_item"      => "Voir les Formations",
                     "update_item"    => "Mettre à jour les Formations",
                     "add_new_item"   => "Ajouter une nouvelle Formation",
                     "search_item"    => "Rehercher dans les Formations"),
                 "hierarchical"  => true,
                 "show_in_menu"  => true,
                 "show_in_rest"  => true,
    ...
    register_taxonomy('formations', 'formation', $taxoFormations );
